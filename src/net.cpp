...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("LuminosityCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("LuminosityCoin-net");
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("LuminosityCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("LuminosityCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("LuminosityCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("LuminosityCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. LuminosityCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("LuminosityCoin-start");
