...
unsigned int nStakeMaxAge = 20 * 24 * nOneHour; //  days as full weight
...
const string strMessageMagic = "LuminosityCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("LuminosityCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in LuminosityCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // LuminosityCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LuminosityCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "luminosity genesis";
        CTransaction txNew;
        ...
        block.nNonce   = 1953170; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xf4, 0xe8, 0xbb, 0xe4 };
