...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XUM");
    case mBTC: return QString("mXUM");
    case uBTC: return QString::fromUtf8("μXUM");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("LuminosityCoins"));
    case mBTC: return QString(QObject::tr("Milli-LuminosityCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-LuminosityCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
