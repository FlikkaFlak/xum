LuminosityCoin-qt: Qt4 GUI for LuminosityCoin
===============================
...
Alternatively, install Qt Creator and open the `LuminosityCoin-qt.pro` file.

An executable named `LuminosityCoin-qt` will be built.
...
A warning for people using the *static binary* version of LuminosityCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of LuminosityCoin is linked against libdb5.3.
...
installed causes LuminosityCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
